...
class DAF_stack(nn.Module):
    ...
    def forward(self, x):
        ...
        down4 = F.interpolate(self.down4(layer4), size=layer1.size()[2:], mode='bilinear')
        down3 = F.interpolate(self.down3(layer3), size=layer1.size()[2:], mode='bilinear')
        down2 = F.interpolate(self.down2(layer2), size=layer1.size()[2:], mode='bilinear')
        ...
        predict1 = F.interpolate(predict1, size=x.size()[2:], mode='bilinear')
        predict2 = F.interpolate(predict2, size=x.size()[2:], mode='bilinear')
        predict3 = F.interpolate(predict3, size=x.size()[2:], mode='bilinear')
        predict4 = F.interpolate(predict4, size=x.size()[2:], mode='bilinear')

        predict1_2 = F.interpolate(predict1_2, size=x.size()[2:], mode='bilinear')
